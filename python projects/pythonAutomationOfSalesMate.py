...
#screen size is normal 1920x1080
...
pyautogui.sleep(3)  #wait for two seconds
...
pyautogui.sleep(2)
#save the barcode of the product 
pyautogui.typewrite("Biotique product")
pyautogui.sleep(2)

pyautogui.press('enter')
pyautogui.sleep(2)
#close salesmate+ application
